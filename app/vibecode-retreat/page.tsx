...
export const metadata: Metadata = {
  ...
  description:
    'An invite-only, build-or-refund founder retreat. September 5 – 6, Tagaytay City. 15 founders. 24 hours. Walk out with a real, custom app that raises your valuation.',
};
...
function Hero({ priceCentavos, slashedCentavos }: { priceCentavos: number | null; slashedCentavos?: number | null }) {
  const cards = [
    { icon: IC.calendar, k: 'WHEN', v: 'September 5 – 6, 10:00 AM', s: 'Saturday to Sunday' },
...
function BillionaireSession() {
  ...
  return (
    <section className="relative container-tight py-14 sm:py-20">
      ...
      <SpecBar
        items={[
          { icon: IC.calendar, top: 'Sep 5 – 6', bottom: '10 AM' },
