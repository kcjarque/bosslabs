...
export default async function EmailLogsPage({
  ...
  return (
    <div>
      <PageHeader
        title="Email Logs"
        subtitle="Every email sent, in one place — sequence blasts grouped into one line, confirmations kept one by one. Delivered → opened → clicked → bounced updates live from SES."
      />
