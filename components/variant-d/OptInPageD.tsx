...
function CardAnnotation() {
  return (
    <div className="mt-3 flex items-start justify-center gap-2 lg:justify-start">
      {/* Hand-drawn-style arrow pointing up at the card. */}
      <svg
        viewBox="0 0 40 40"
        width="26"
        height="26"
        ...
        className="mt-0.5 shrink-0 -scale-x-100 text-cyan-300"
        aria-hidden
      >
        <path d="M8 34c2-10 10-20 24-26" />
        <path d="M25 6h7v7" />
      </svg>
      <p className="text-[12.5px] leading-snug text-ink-200 sm:text-[13px]">
        Traditional Devs charge minimum ₱500K+ for a system like this...
        <br />
      ...
      <div className="container-tight relative z-10 pt-8 pb-12 sm:pt-12 sm:pb-16">
        ...
        <div className="mt-7 items-start lg:grid lg:grid-cols-[55fr_45fr] lg:gap-12">
          ...
          <div className="text-center lg:text-left">
            ...
            <div className="mt-7">
              <HeroCtaD
                label={`Reserve a Seat — ${OFFER.main.label}`}
